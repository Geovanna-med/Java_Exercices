public class Main {
    ...
    public static void main(String[] args) {
        ...
        nomina.altaEmpleado(new Administrador("Geovanna", 80, 11, 15));
        nomina.altaEmpleado(new Administrador("Gabriel", 70, 20, 15));
        nomina.altaEmpleado(new Administrador("Fernanda", 80, 10, 15));
        nomina.altaEmpleado(new Administrador("Tony", 50, 0, 15));
